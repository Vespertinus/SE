...
g++ -Wall -pedantic ./samples/offscreen_rendering/main_debug.cpp core/InputManager.cpp -I./core -I./common -I./X11 -I./units -I./samples/offscreen_rendering -I../../open_source/tinyobjloader -I../../usr/include -I../../usr/include/loki -I/usr/include/OIS -L/usr/local/lib  -o offscreen_demo -I/usr/include/loki -std=c++1z -L/usr/X11R6/lib -L../../usr/lib  -lX11 -lXxf86vm -lGL -lGLU -lOIS -lm -O0 -lopencv_core -lopencv_highgui -lboost_system -lboost_filesystem
