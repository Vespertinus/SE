...
void GBuffer::Create() {
        ...
        // RT1: world-normal (RGB) + metallic (A) — RGBA16F
        ...
        oTexStock.internal_format = GL_DEPTH_COMPONENT24;
        oTexStock.format          = GL_DEPTH_COMPONENT;
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT,  GL_TEXTURE_2D, pDepth->GetID(), 0);
