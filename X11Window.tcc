...
template <class ResizeHandler,  class DrawHandler> X11Window<ResizeHandler, DrawHandler>::X11Window(ResizeHandler & oNewResizeHandler, DrawHandler & oNewDrawHandler, const WindowSettings & oNewSettings) :
  display(0),
  window(0),
  glx_context(0),
  screen(0),
